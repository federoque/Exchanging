...
export function metricFormat(metric){
    return {
        ...
        percent_change_usd_last_24_hours: metric.data.market_data.percent_change_usd_last_24_hours.toFixed(2),
...
export function timeSeriesFormat(timeseries){
    return {
        ...
        time_series:[
            ...
            {name: 'day_one_high', value: timeseries.data.values[0][2]},
            {name: 'day_one_low', value: timeseries.data.values[0][3]},
            {name: 'day_one_close', value: timeseries.data.values[0][4]},
            {name: 'day_two_open', value: timeseries.data.values[1][1]},
            {name: 'day_two_high', value:  timeseries.data.values[1][2]},
            {name: 'day_two_low', value: timeseries.data.values[1][3]},
            {name: 'day_two_close', value: timeseries.data.values[1][4]},
            {name: 'day_three_open', value: timeseries.data.values[2][1]},
            {name: 'day_three_high', value: timeseries.data.values[2][2]},
            {name: 'day_three_low', value: timeseries.data.values[2][3]},
            {name: 'day_three_close', value: timeseries.data.values[2][4]},
            {name: 'day_four_open', value: timeseries.data.values[3][1]},
            {name: 'day_four_high', value: timeseries.data.values[3][2]},
            {name: 'day_four_low', value: timeseries.data.values[3][3]},
            {name: 'day_four_close', value: timeseries.data.values[3][4]},
            {name: 'day_five_open', value: timeseries.data.values[4][1]},
            {name: 'day_five_high', value: timeseries.data.values[4][2]},
            {name: 'day_five_low', value: timeseries.data.values[4][3]},
            {name: 'day_five_close', value: timeseries.data.values[4][4]},
            {name: 'day_six_open', value: timeseries.data.values[5][1]},
            {name: 'day_six_high', value: timeseries.data.values[5][2]},
            {name: 'day_six_low', value: timeseries.data.values[5][3]},
            {name: 'day_six_close', value: timeseries.data.values[5][4]},
            {name: 'day_seven_open', value: timeseries.data.values[6][1]},
            {name: 'day_seven_high', value: timeseries.data.values[6][2]},
            {name: 'day_seven_low', value: timeseries.data.values[6][3]},
